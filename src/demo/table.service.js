module.exports = function(ngModule){
    ngModule.factory('tableService', function ($q) {
        return {
            getData: function() {
                return [
                    { id: 1, name: 'John has a very very very long name - do the columns remain aligned?', age: 10, country:'England'},
                    { id: 2, name: 'Jim', age: 20, country:'Scotland'},
                    { id: 3, name: 'Jane', age: 30, country:'Ireland'},
                           { id: 1, name: 'John has a very very very long name - do the columns remain aligned?', age: 10, country:'England'},
                    { id: 2, name: 'Jim', age: 20, country:'Scotland'},
                    { id: 3, name: 'Jane', age: 30, country:'Ireland'},
                           { id: 1, name: 'John has a very very very long name - do the columns remain aligned?', age: 10, country:'England'},
